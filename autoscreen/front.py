...
import os
from autoscreen import selenium_updated
...
def clear():
        ...
        fb_label.place_forget()
        fb_password.place_forget()
        fb_username.place_forget()

        x_label.place_forget()
        x_password.place_forget()
        x_username.place_forget()
...
def insta_():
    ...
    say_label.place(x=441,y=81)
    insta_username.place(x=248,y=154)
    insta_password.place(x=248,y=215)

    fb_label.place(x=434,y=283)
    fb_username.place(x=248,y=353)
    fb_password.place(x=248,y=410)

    x_label.place(x=478,y=483) 
    x_username.place(x=248,y=555)
    x_password.place(x=248,y=616)
    
    #keyword_label.place(x=248,y=410)
    #key_text.place(x=248,y=480)
    collect_evidence_button.place(x=248,y=735)
...
def collect():
    ...
    fb_user=fb_username.get()
    fb_pass=fb_password.get()

    x_user=x_username.get()
    x_pass=x_password.get()
    
    return (insta_user,insta_pass,fb_user,fb_pass,x_user,x_pass)
...
def loading():
    ...
    #loading_bar.start()
    details=collect()
    selenium_updated.login_to_face(details[2], details[3])
    selenium_updated.login_to_twitter(details[4],details[5])
...
fb_username=CTkEntry(root,text_color="black",placeholder_text="username",fg_color="white",bg_color="black",width=484,height=48)
fb_password=CTkEntry(root,placeholder_text="password",text_color="black",show="*",fg_color="white",bg_color="black",width=484,height=48)

x_username=CTkEntry(root,text_color="black",placeholder_text="username",fg_color="white",bg_color="black",width=484,height=48)
x_password=CTkEntry(root,placeholder_text="password",text_color="black",show="*",fg_color="white",bg_color="black",width=484,height=48)
...
ques_label=CTkLabel(root,text="Instagram",
    text_color="black",
    fg_color="white",
    font=("Helvetica",34),
    bg_color="white")

fb_label=CTkLabel(root,text="FaceBook",
    text_color="black",
    fg_color="white",
    font=("Helvetica",34),
    bg_color="white")

x_label=CTkLabel(root,text="X",
    text_color="black",
    fg_color="white",
    font=("Helvetica",34),
    bg_color="white")
